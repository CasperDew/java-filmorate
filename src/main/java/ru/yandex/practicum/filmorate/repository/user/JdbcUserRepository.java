...
public class JdbcUserRepository implements UserRepository {
    ...
    public Optional<User> getById(Long id) {
        ...
        List<User> users = jdbc.query(selectUser, params, rowMapper);
    ...
    public void deleteById(Long id) {
        MapSqlParameterSource params = new MapSqlParameterSource()
                .addValue("id", id);
        String deleteUserById = "DELETE FROM users WHERE user_id = :id";
        jdbc.update(deleteUserById, params);
    }
    ...
    @Override
    public List<User> findAllCommonFriends(long userId1, long userId2) {
        MapSqlParameterSource params = new MapSqlParameterSource()
